...
const Orders = (props) => {
  ...
  React.useEffect(()=>{
    axios.get("http://127.0.0.1:8000/api/v1/items_list").then((res)=>{
  ...
  React.useEffect(() => {
    // console.log("fetched");
    axios.get("http://127.0.0.1:8000/api/v1/po_list").then((res) => {
      // console.log(res.data)
      setPoData(res.data)
    });
  }, []);
  ...
  const deleteVendor = (id) => {
    ...
    axios.delete(`http://127.0.0.1:8000/api/v1/po/${id}`).then(()=>{
