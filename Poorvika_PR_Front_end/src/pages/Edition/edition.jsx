...
const Edition = ()=>{
  ...
  React.useEffect(()=>{
    Axios.get('http://127.0.0.1:8000/api/v1/Edition',{
    }).then((response) => {
  ...
  React.useEffect(()=>{
    Axios.get('http://127.0.0.1:8000/api/v1/Publication',{
    }).then((response) => {
    ...
    React.useEffect(()=>{
      Axios.get('http://127.0.0.1:8000/api/v1/State',{
      }).then((response) => {
  ...
  const handleSubmit=(e) =>{
    e.preventDefault();
    Axios.post('http://127.0.0.1:8000/api/v1/Edition_Add',{
      edition: idofedition,
