...
const ROrders = (props) => {
  ...
  React.useEffect(() => {
    // console.log("fetched");
    axios.get("http://127.0.0.1:8000/api/v1/ro_list").then((res) => {
  ...
  React.useEffect(() => {
    // console.log("fetched");
    axios.get("http://127.0.0.1:8000/api/v1/ro_Pub_date_list").then((res) => {
      // console.log(res.data)
      setPubData(res.data)
    });
  }, []);
  ...
  React.useEffect(() => {
    // console.log("fetched");
    axios.get("http://127.0.0.1:8000/api/v1/ro_edition_list").then((res) => {
      // console.log(res.data)
  ...
  const deleteVendor = (id) => {
    ...
    axios.delete(`http://127.0.0.1:8000/api/v1/ro/${id}`).then(()=>{
